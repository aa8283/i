...
function UILibrary:CreateWindow(title, width, height)
    ...
    OuterFrame.BackgroundTransparency = 1 -- Start hidden
    ...
    local function CloseUI()
        TweenService:Create(OuterFrame, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.In), {
            ...
            Position = UDim2.new(0.5, -windowWidth/2, 1, 0) -- Slide down
        }):Play()
        task.wait(0.5)
        ScreenGui:Destroy()
    end
    ...
    local function ToggleUI()
        ...
        if isVisible then
            ...
            TweenService:Create(OuterFrame, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.In), {
                Position = UDim2.new(0.5, savedPos.X.Offset, 1, 0), -- Slide down
                BackgroundTransparency = 1
            }):Play()
        end
    end
